    ...
    public partial class Quanlynhanvien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaNv.Text.Trim() == "")
                ...
                nvb.insertNV(txtMaNv.Text, txtTenNv.Text, dtpNgaysinh.Value.ToString("dd/MM/yyyy"), txtDiachi.Text, luongnv, txtPhongBan.Text, txtDuAn.Text);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            if (txtMaNv.Text.Trim() == "")
                ...
                nvb.updateNV(txtMaNv.Text, txtTenNv.Text, dtpNgaysinh.Value.ToString("dd/MM/yyyy"), txtDiachi.Text, luongnv, txtPhongBan.Text, txtDuAn.Text);
            Quanlynhanvien_Load(sender, e);
        }
        ...
        private void dgvNhanVien_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (row >= 0)
            {
                ...
                txtPhongBan.Text = nvb.selectPB(mapb);
                txtDuAn.Text = nvb.selectDA(mada);
            }
        }
